...
import com.doctors.form.Repository.ImageRepository;
...
public class ImageUploadController {
	...
	public ImageModel getImagebyId(@PathVariable("imageId") long imageId) throws IOException {
	...
	@GetMapping("/getall")
 	public List<ImageModel> getUsers() {
